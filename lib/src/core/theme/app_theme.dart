...
// Project imports:
import 'package:hanahaki_tools/src/core/theme/color_schemes.dart';
import 'package:hanahaki_tools/src/core/theme/custom_colors.dart';

class AppTheme {
  static const _fontFamily = 'GeneralSans';

  static ThemeData _buildTheme({required Brightness brightness}) {
    final ColorScheme colors = brightness == Brightness.light
        ? lightColorScheme
        : darkColorScheme;
