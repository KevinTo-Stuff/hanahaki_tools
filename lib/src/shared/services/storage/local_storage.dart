...
class LocalStorage extends Storage {
  ...
  }) async => await _sharedPreferences.setDouble(key, value);
  ...
  }) async => await _sharedPreferences.setString(key, value);

  @override
  Future<bool> writeStringList({
    required String key,
    required List<String> value,
  }) async => await _sharedPreferences.setStringList(key, value);
}
